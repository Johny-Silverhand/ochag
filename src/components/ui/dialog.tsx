...
export function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay className="sheet-backdrop fixed inset-0 z-[60] data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0" />
      <DialogPrimitive.Content
        className={cn(
          "glass-sheet fixed z-[60] max-h-[var(--dialog-max-h)] min-w-0 overflow-x-hidden overflow-y-auto text-fg overscroll-contain opacity-100 focus:outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
