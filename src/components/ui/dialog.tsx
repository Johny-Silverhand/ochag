  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 flex max-h-[var(--dialog-max-h)] min-w-0 flex-col overflow-hidden bg-surface text-fg opacity-100 shadow-(--shadow-border) focus:outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
      ...
      >
        ...
        <div className="dialog-scroll -mx-1 px-1">{children}</div>
      </DialogPrimitive.Content>
    </DialogPrimitive.Portal>
  );
}
