  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 max-h-[var(--dialog-max-h)] min-w-0 overflow-x-hidden overflow-y-auto bg-surface text-fg overscroll-contain opacity-100 shadow-(--shadow-border) focus:outline-none data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
