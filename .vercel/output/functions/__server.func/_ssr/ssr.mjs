...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-St7Td6Lx.mjs");
...
var manifest = {
	"2898c98d0ea59d49dc84dd87aea487b8880a5577c10ac877b53332a3c34fab56": {
		functionName: "getOpsStatus_createServerFn_handler",
		importer: () => import("./ops-EnFN6OWE.mjs")
	},
	"83392b05222cfb092da4ca48f939f62ed42b9d0cde81a752fce41669b75340c9": {
		functionName: "saveOpsSnapshot_createServerFn_handler",
		importer: () => import("./ops-EnFN6OWE.mjs")
	},
	"af9235ab17390a7e942c3a53ff84be2703e6aa56593e272fe15dfcda4698df63": {
		functionName: "loadOpsSnapshot_createServerFn_handler",
		importer: () => import("./ops-EnFN6OWE.mjs")
	},
	"e2453859e9d2be9576663f41de4f95bb9ebda0338ae13171444d6a23b6762ed8": {
		functionName: "resetOpsSnapshot_createServerFn_handler",
		importer: () => import("./ops-EnFN6OWE.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DjPwU5Qt.mjs").then((n) => n.t),
