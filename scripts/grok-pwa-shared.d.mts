...
export declare function isGrokPlatformHost(hostHeader: string | null | undefined): boolean;
export declare function shouldInjectGrokAppChrome(hostHeader: string | null | undefined): boolean;
