...
1. **Environment**
   ...
   - Опционально `OCHAG_APP_ORIGIN`, если API когда-нибудь откроют с другого origin. Боевые хосты `https://restopro-theta.vercel.app` и `https://ochag-theta.vercel.app` уже разрешены в коде.
